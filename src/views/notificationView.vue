...
export default {
    ...
    methods:{
        ...
        async getNotification(){
            ...
            await axios.post('https://dashboard.mueadaat.info/test-mode/api/show-notification', {
        ...
        async deleteNotification(id){
            ...
            await axios.post('https://dashboard.mueadaat.info/test-mode/api/delete-notification', {
                 lang: localStorage.getItem('locale'),
                 notification_id: id
            })
            .then( (res)=>{
