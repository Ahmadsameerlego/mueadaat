...
<Carousel :autoplay="2000" v-bind="settings"  :breakpoints="breakpoints" v-if="fav_item">
      <Slide v-for="equipment in fav_item.fav_item" :id="equipment.id" :key="equipment.id">
        <div class="carousel__item">
          <!-- Start Post -->
          <div class="post">
              <div class="post-img">
                  <router-link to="/workers/:id">
                    <img :src="equipment.first_image" ></router-link>
              ...
              <div class="post-info">
                  <div class="row">
                      <div class="col-sm-8">
                          ...
                          <span class="post-date text-body"><fa icon="heart" /> 
                            {{equipment.unit}}</span>
                      </div>
                      <div class="col-sm-4">
